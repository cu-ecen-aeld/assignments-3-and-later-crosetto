...
void test_validate_my_username()
{
    ...
    char const* username = my_username();
     ...
     */
    bool equal=true;
    for(int c=0; username[c]!=0 && from_file[c] != 0; ++c){
      if(username[c] != from_file[c])
        equal = false;
    }    
    TEST_ASSERT_TRUE_MESSAGE(equal,"AESD students, please fix me!");
}
